...
public class ImporterDataTest extends ImporterTestSupport {
    ...
    public void testImportIntoDatabaseWithEncoding() throws Exception {
        ...
        FeatureTypeInfo info = (FeatureTypeInfo) context.getTasks().get(0).getItems().get(0)
                .getLayer().getResource();
        FeatureSource<? extends FeatureType, ? extends Feature> fs = info.getFeatureSource(null,
                null);
    ...
    public void testImportIntoDatabaseUpdateModes() throws Exception {
        ...
        FeatureSource<? extends FeatureType, ? extends Feature> fs = getCatalog()
                .getFeatureTypeByName("archsites").getFeatureSource(null, null);
