...
public final class GeoserverSupport {
    ...
    /**
     * Get the 'output' directory - this is for temporary output to support
    ...
    /**
     * Get a printng directory - this will be under $datadir/printng or in
     * the system tempdir if geoserver is not running (unit test mode).
     * @param path
     * @return non-null File
     * @throws IOException 
     */
    ...
    /**
     * @todo - if/when ever this type of activity has support from geoserver
     * at a more formalized level (a common task pool anyone?) either remove
     * or fix to use that.
     */
